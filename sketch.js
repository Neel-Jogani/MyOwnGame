...
function draw() {
  ...
  if(gameState===START)
  {
    ...
    var author=createElement('h3');
    author.html("BY : NEEL JOGANI");
    author.position(displayWidth/2-90,displayHeight/2+100);
...
if(gameState===END){
 ...
 // text("Your final score 👆",displayWidth-350,displayHeight/2-150);
  ...
  if(gameState===END){
    ...
    stroke("black");
    fill("purple");
    text("You lost!🤦‍....But you played verryy well Don't worry,we have a restart button somewhere above.",displayWidth/2-635,displayHeight/2+100);
    text("Press it to play more and score more!!-Flappy...",displayWidth/2-630,displayHeight/2+150);
